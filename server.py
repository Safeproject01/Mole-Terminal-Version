...
|_____|_____|__|__|\___/|_____|__|__|
 ...
 [+] Welcome to your Mole server [+]

 [-] Tool Created by Safe Project [-]
                """)
        ...
        while True:
            try:
                ...
                ## Receiving images and files
                    ...
                    if not os.path.exists('Mole_files'):
                        os.mkdir('Mole_files')

                    fname1 = 'Mole_files/' + fname
                    try:
                        with open(fname1, "wb") as f:
    ...
    def accept_conn(self):
        while True:
            ...
            self.broadcast("\n [{}] joined!".format(self.clients_dict[client]).encode('utf-8'), client)
